...
MAPEAMENTO_BD_ACOES = (
    ...
    ColunaSheet(24, "Y", "reservado_y", "Reservado", "float", "—", "scraper_acoes",
                "—", TEMPORARIO, None, "slots reservados"),
    ColunaSheet(25, "Z", "cagr_rec_5a", "Cresc. Rec. 5a (CAGR)", "float",
                "CVM (fallback Fundamentus)", "scraper_acoes", "—", MAPEADO,
                "snapshots_acoes.cagr_rec_5a"),
    ColunaSheet(26, "AA", "cagr_lucro_5a", "Cresc. Lucro 5a (CAGR)", "float", "CVM",
                "scraper_acoes", "—", TEMPORARIO, None,
                "indicadores_cvm_acoes.cagr_lucro_5a; sem coluna em snapshots_acoes"),
